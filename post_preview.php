                ...
                <a class="feautered-<?= $post['item_num'] ?>__link" href="#"><?= $post['button'] ?></a>
                <div class="feautered-item__content">
                  <p class="feautered-item__naming"><?= $post['title'] ?></p>
                  ...
                  <div class="feautered-item__information">
                    <div class="feautered-item__autor">
                      <img
                        ...
                        src="/image/<?= $post['img_modifier'] ?>"
                        alt="author_photo"
							>
                      <p class="feautered-autor__name"><?= $post['author'] ?></p>
                    </div>
                    <p class="feautered-item__date"><?= $post['date'] ?></p>
                  </div>
                </div>
              </div>

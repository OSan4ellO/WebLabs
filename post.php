  ...
  <body>
    <header class="header">
      <div class="header-navigation">
        <img class="header-logo" src="image/logo_b.svg" />
    ...
    <main class="main">
      ...
      <div class="text">
        <p class="paragraph">
          ...
          savage, frozen-hearted Northland Wild. <br /><br />
    ...
    <footer class="footer">
      <div class="footer-navigation">
        <img src="image/logo_w.svg" class="footer-logo" />
